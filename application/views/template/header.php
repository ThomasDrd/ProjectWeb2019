...
<head>
	...
	<!--
	<script src="<?php echo base_url(); ?>js/core/jquery.min.js" type="text/javascript"></script>
	<script src="<?php echo base_url(); ?>js/core/popper.min.js" type="text/javascript"></script>
	<script src="<?php echo base_url(); ?>js/core/bootstrap-material-design.min.js" type="text/javascript"></script>
	Control Center for Material Kit: parallax effects, scripts for the example pages etc -->
	<!--A garder pour les clic-->

	<script src="<?php echo base_url(); ?>js/material-kit.js?v=2.2.0" type="text/javascript"></script>
